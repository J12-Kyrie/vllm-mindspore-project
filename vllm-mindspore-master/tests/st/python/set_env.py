...
# 使用相对路径
mindformers_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../mindformers"))
...
class EnvVarManager:
    ...
    def setup_cpu_environment(self) -> None:
        """设置CPU运行环境"""
        env_vars = {
            "DEVICE_TARGET": "CPU",
            "MS_DEVICE_TARGET": "CPU",
            "MS_ENABLE_CPU_KERNEL": "1",
            "MS_ENABLE_GRAPH_KERNEL": "1"
        }
        self.setup_ai_environment(env_vars)
